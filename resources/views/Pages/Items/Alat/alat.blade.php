            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td width="112px">
                    <div class="">
                    <a class="btn btn-block btn-sm btn-success col-12 d-inline" href="/pages/alat/perangkat/edit/{{$item->id}}">Detail</a>
                    <a class="btn btn-block btn-sm btn-danger col-12 d-inline" href="/pages/alat/perangkat/delete/{{$item->id}}">Hapus</a>
                    </div>
                  </td>
                </tr>
                @endforeach
