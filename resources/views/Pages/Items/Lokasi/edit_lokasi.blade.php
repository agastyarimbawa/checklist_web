            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="/pages/items/lokasi/update/{{$item->id}}">
                            @csrf
                            <form role="form">
                                <div class="card-body col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama Lokasi</label>
                                        <input id="nama_lokasi" type="text" class="form-control @error('nama_lokasi') ? ' is-invalid' : '' @enderror" name="nama_lokasi" value="{{ $item->nama_lokasi }}" required autocomplete="nama_lokasi" autofocus>
