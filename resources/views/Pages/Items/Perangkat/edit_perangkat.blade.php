            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="/pages/items/perangkat/update/{{$item->id}}">
                            @csrf
                            <form role="form">
                                <div class="card-body col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="nama_perangkats" type="text" class="form-control @error('tipe_objeks') is-invalid @enderror"name="nama_perangkats" value="{{ $item->nama_perangkats }}" placeholder="Masukkan nama perangkat" required autocomplete="nama_perangkats" autofocus>
                                    </div>
                            </div>
                    <!-- /.card-body -->
